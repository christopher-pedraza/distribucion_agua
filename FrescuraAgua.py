...
def max_delay_per_sector(graph):
    ...
    for node_id, node_info in graph.items():
        ...
        sector_nodes = [n_id for n_id, n_info in graph.items() if n_info['sector'] == sector and not n_info['fuente']]
        distances = {}
        ...
        for sector_node in sector_nodes:
            ...
            valid_distances = {n: distances_from_node[n] for n in distances_from_node if not graph[n]['fuente'] and graph[n]['sector'] == sector}
